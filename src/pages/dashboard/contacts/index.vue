        ...
        <section>
            <v-card elevation="1" class="tw-w-full tw-min-h-[600px] tw-p-4">
                <div class="tw-grid tw-py-4 tw-px-4">
                    ...
                    <v-text-field v-model="currentFilter" label="Buscar un contacto" density="comfortable"
                        prepend-inner-icon="mdi-magnify" color="primary" base-color="primary" clearable="true" />
                    <div class="tw-flex tw-gap-2 tw-items-center">
                        <v-btn v-for="filter in filters" :key="filter.value" color="primary" variant="outlined"
                            :variant="filter.value === 'all' ? '' : 'flat'" density="comfortable">
                            {{ filter.text }}
                        </v-btn>
                    </div>
                </div>
